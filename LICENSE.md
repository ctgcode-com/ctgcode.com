...
## VERSIÓN EN ESPAÑOL (Legalmente Vinculante)
...
Queda estrictamente prohibida cualquier acción que no cuente con la autorización expresa, previa y por escrito del titular de los derechos. Esto incluye, pero no se limita a:

- **Reproducción y Copia:** Clonar, copiar, duplicar o replicar de manera parcial o total el código fuente o la identidad visual de este sitio web para uso comercial o personal.
- **Distribución:** Distribuir, sublicenciar, arrendar, vender o transferir este software a terceros.
- **Modificación:** Modificar, alterar, transformar o crear obras derivadas basadas en este software para su puesta en producción bajo un dominio o marca diferente.
...
Any action without the express, prior, and written authorization of the copyright holder is strictly prohibited. This includes, but is not limited to:

- **Reproduction and Copying:** Cloning, copying, duplicating, or replicating partially or totally the source code or visual identity of this website for commercial or personal use.
- **Distribution:** Distributing, sublicensing, leasing, selling, or transferring this software to third parties.
- **Modification:** Modifying, altering, transforming, or creating derivative works based on this software for production use under a different domain or brand.
